...
$img=0;
$id=0;
$SQLC = "select * from cases where id_sodality= $SodalityId";
...
$CaseId=$row5['id_case'];//take the id for case
...
$table6 = mysqli_query($conn, $SQL6);
	...
	$year=$row6['year'];
	$response[]=array($CaseId,$SodalityId,$studentId,$studenEmail,$money,$des,$name_u,$college,$year,$img,$name);
